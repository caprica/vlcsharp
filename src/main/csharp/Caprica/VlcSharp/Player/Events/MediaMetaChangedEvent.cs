...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaMetaChangedEvent : AbstractMediaPlayerEvent {

        /**
         * Meta type.
         */
        private readonly int metaType;
         ...
         */
        protected internal MediaMetaChangedEvent(MediaPlayer mediaPlayer, int metaType) : base(mediaPlayer) {
