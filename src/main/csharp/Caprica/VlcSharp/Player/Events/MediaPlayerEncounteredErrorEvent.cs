...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaPlayerEncounteredErrorEvent : AbstractMediaPlayerEvent {
         ...
         */
        protected internal MediaPlayerEncounteredErrorEvent(MediaPlayer mediaPlayer) : base(mediaPlayer) {
        }
