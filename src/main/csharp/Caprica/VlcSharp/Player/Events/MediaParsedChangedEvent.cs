...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaParsedChangedEvent : AbstractMediaPlayerEvent {
         ...
         */
        protected internal MediaParsedChangedEvent(MediaPlayer mediaPlayer, int newStatus) : base(mediaPlayer) {
