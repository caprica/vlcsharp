...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaDurationChangedEvent : AbstractMediaPlayerEvent {
 
        /**
         * Duration.
         */
        private readonly long newDuration;
         ...
         */
        protected internal MediaDurationChangedEvent(MediaPlayer mediaPlayer, long newDuration) : base(mediaPlayer) {
