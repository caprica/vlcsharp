...
namespace Caprica.VlcSharp.Player.Events {
     ...
     */
    abstract class AbstractMediaPlayerEvent : MediaPlayerEvent {

        /**
         * The media player the event relates to.
         */
        protected readonly MediaPlayer mediaPlayer;
        ...
        public abstract void Notify(MediaPlayerEventListener listener);
    }
}