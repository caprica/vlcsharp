...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaSubItemPlayedEvent : AbstractMediaPlayerEvent {
         ...
         */
        protected internal MediaSubItemPlayedEvent(MediaPlayer mediaPlayer, int subItemIndex) : base(mediaPlayer) {
