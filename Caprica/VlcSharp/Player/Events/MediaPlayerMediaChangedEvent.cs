...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaPlayerMediaChangedEvent : AbstractMediaPlayerEvent {

        /**
         *
         */
        private readonly IntPtr newMedia;
         ...
         */
        protected internal MediaPlayerMediaChangedEvent(MediaPlayer mediaPlayer, IntPtr newMedia, string mrl) : base(mediaPlayer) {
