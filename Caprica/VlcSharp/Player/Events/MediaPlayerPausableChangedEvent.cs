...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaPlayerPausableChangedEvent : AbstractMediaPlayerEvent {

        /**
         *
         */
        private readonly int newPausable;
         ...
         * @param newPausable
         */
        protected internal MediaPlayerPausableChangedEvent(MediaPlayer mediaPlayer, int newPausable) : base(mediaPlayer) {
