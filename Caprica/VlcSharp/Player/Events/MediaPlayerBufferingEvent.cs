...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaPlayerBufferingEvent : AbstractMediaPlayerEvent {
 
        /**
         *
         */
        private readonly float newCache;
         ...
         */
        protected internal MediaPlayerBufferingEvent(MediaPlayer mediaPlayer, float newCache) : base(mediaPlayer) {
