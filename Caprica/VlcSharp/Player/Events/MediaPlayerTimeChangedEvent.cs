...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaPlayerTimeChangedEvent : AbstractMediaPlayerEvent {

        /**
         *
         */
        private readonly long newTime;
         ...
         * @param newTime
         */
        protected internal MediaPlayerTimeChangedEvent(MediaPlayer mediaPlayer, long newTime) : base(mediaPlayer) {
