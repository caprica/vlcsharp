...
namespace Caprica.VlcSharp.Player.Events {
     ...
     *
     */
    class MediaPlayerNothingSpecialEvent : AbstractMediaPlayerEvent {
         ...
         */
        protected internal MediaPlayerNothingSpecialEvent(MediaPlayer mediaPlayer) : base(mediaPlayer) {
        }
